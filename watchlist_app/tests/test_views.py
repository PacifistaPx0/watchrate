...
class MovieAPITest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        Movie.objects.create(name="Inception", description="Dream-sharing technology.", active=True)
    ...
    def test_post_valid_movie(self):
        data = {"name": "New Movie", "description": "About tests", "active": True}
        response = self.client.post(reverse('movie-list'), data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)

    def test_put_valid_movie(self):
        data = {"name": "Inception Updated", "description": "Updated description", "active": False}
